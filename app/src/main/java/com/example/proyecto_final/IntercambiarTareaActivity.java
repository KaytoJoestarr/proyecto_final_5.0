...
public class IntercambiarTareaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_atras.setOnClickListener(new View.OnClickListener() { // Boton Atras
            ...
            public void onClick(View v) {
                Intent intent = new Intent(IntercambiarTareaActivity.this, HomeActivity.class);
        ...
        btn_hecho.setOnClickListener(new View.OnClickListener() { // Boton Atras
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(IntercambiarTareaActivity.this, HomeActivity.class);
                startActivity(intent);
